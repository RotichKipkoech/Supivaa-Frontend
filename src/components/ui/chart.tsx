...
/**
 * Accept both tooltip and legend items
 */
type PayloadType = TooltipPayload | RechartsPrimitive.LegendPayload | PayloadEntry;
      ...
      >
        ...
        <div className="grid gap-1.5">
          {payload.map((item, index) => {
            ...
            const itemConfig = getPayloadConfigFromPayload(config, item, key);
            const indicatorColor = color || (item.payload as PayloadEntry)?.fill?.toString() || item.color;
...
function getPayloadConfigFromPayload(config: ChartConfig, payload: PayloadType, key: string) {
